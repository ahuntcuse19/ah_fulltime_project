          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {cases.map((c) => {
                ...
                return (
                  <tr key={c.id} data-testid="case-row" className="cursor-pointer border-t border-ink-100 align-top hover:bg-paper" onClick={open}>
                    ...
                    <td className="px-4 py-3 text-right font-mono tabular-nums">{daysOpen(s, c)}</td>
